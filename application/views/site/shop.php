...
<div class="headig3">
  ...
  <ul class="ul_set list1 mb-4">
     <li><a href="#"> Led Backlite panel</a></li>
     <li><a href="#"> Conseal</a></li>
     <li><a href="#"> Cob (Spot ) LED light</a></li>
     <li><a href="#"> Led bulb</a></li>
     <li><a href="#"> AC/DC Bulb</a></li>
     <li><a href="#"> Music bulb</a></li>
     <li><a href="#"> Tubelight T-5</a></li>
  </ul>
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <div class="box_d2">
          <span class="hobb">
          <a href="Product-Details"></a>  
          <img src="<?= site_url('assets/site/'); ?>img/img13.png" alt="" class="img_r"></span>
          <div class="con_st">
            <h4>Led Backlite panel</h4>
            <h2>RS. 280.00</h2>
            <div class="colr">
      ...
      <div class="col-sm-4">
        <div class="box_d2">
          <span class="hobb">
          <a href="Product-Details"></a>  
          <img src="<?= site_url('assets/site/'); ?>img/img14.png" alt="" class="img_r"></span>
          <div class="con_st">
            <h4>Led Backlite panel</h4>
            <h2>RS. 280.00</h2>
            <div class="colr">
